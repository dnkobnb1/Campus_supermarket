<%@ page language="java" import="java.sql.*" import="java.net.*" contentType="text/html; charset=utf-8" import="java.util.*" pageEncoding="utf-8"%>
<%
...
<html>
  ...
  <body>
	...
	<div class="main">
		...
		String sql="select * from commdity where type='drink'";
